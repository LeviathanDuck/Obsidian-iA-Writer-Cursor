...
This plugin is simple enough to not need a build pipeline — it's plain JavaScript and CSS. Edit `main.js` and `styles.css` directly, then reload the plugin in Obsidian.
